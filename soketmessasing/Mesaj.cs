...
{
    public class Dosya //dosyanın yolunu ve adını saklamak için kullanılır.
    {
    ...
    [Serializable]
    class Mesaj //Mesaj Sınıfı ve Özellikleri
    {
        ...
        public void DosyaEkle(string filePath, string fileName) //Dosya eklemek için kullanılır. Dosya yolu ve adı parametre olarak alınır.
        {
        ...
        //Mesaja dosya iliştirme fonksiyonu
        public void DosyaEkle(byte[] FileAsByteArray, string fileName) //Dosyanın bayt dizisi olarak eklenmesi için kullanılır.
        {
            //Dosyayı sıkıştırıp kaydediyoruz mesaja
        ...
        public void Sifrele(string key) // Mesajı ve ekli dosyaları verilen anahtar (key) ile şifreler.
        {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public bool Desifrele(string key) //Mesaj Şifre Çözme Fonksiyonu
        {
